...
export default function SpecialEvents() {
  ...
  return (
    <>
    <br/><br/>
    <h1 className='specialEvents' >   <center>Special Events</center></h1>
    <br/><br/><br/>
    <Box
      sx={{
        height: 500,
    ...
    >
      <Tabs value={value} onChange={handleChange} aria-label="basic tabs example"> 
          <Tab label="Dinner CockTails" {...a11yProps(0)} />
          <Tab label="Golf" {...a11yProps(1)} />
          <Tab label="YP Event" {...a11yProps(2)} />
        </Tabs>
