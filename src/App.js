...
function App() {
  ...
  return (<>
    ...
    <Routes>
      ...
      <Route path='/chapter/teamChallenge' element={<TeamChallenge isAdmin={false} chapter={chapter} />} />
      ...
      <Route path='/chapter/specialEvents' element={<SpecialEvents isAdmin={false} chapter={chapter}/>} />
      ...
      <Route path='/chapter/administration(M&T)' element={<AdministrationMT isAdmin={false} chapter={chapter}/>} />
      <Route path='/template/budgetSpread' element={<BudgetSpread isAdmin={true} />} />
      <Route path='/chapter/budgetSpread' element={<BudgetSpread isAdmin={false} chapter={chapter}/>} />
    </Routes>
  </>
  );
}
